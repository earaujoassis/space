...
func validateModel(tagName string, model interface{}) error {
	...
	validate.RegisterValidation("scope_restrict", validClientScopes)
	validate.RegisterValidation("token", validTokenType)
	validate.RegisterValidation("canonical_uri", validCanonicalURIs)
	validate.RegisterValidation("redirect_uri", validRedirectURIs)
