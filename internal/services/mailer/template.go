...
func CreateMessage(templateName string, data interface{}) string {
	templateName = fmt.Sprintf("internal/services/mailer/templates/%s", templateName)
	parser, _ := template.ParseFiles("internal/services/mailer/templates/default.html", templateName)
