...
func (s *UsersTestSuite) TestCreateHandlerWithoutHeader() {
...
func (s *UsersTestSuite) TestCreateHandlerWhenFeatureIsDisabled() {
	header := &http.Header{
...
func (s *UsersTestSuite) TestCreateHandlerWithoutData() {
	header := &http.Header{
		"X-Requested-By": []string{"SpaceApi"},
	}
...
func (s *UsersTestSuite) TestCreateHandler() {
	header := &http.Header{
		"X-Requested-By": []string{"SpaceApi"},
	}
