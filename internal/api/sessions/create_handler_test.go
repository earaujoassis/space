...
func (s *SessionsTestSuite) TestCreateHandlerWithoutHeader() {
...
func (s *SessionsTestSuite) TestCreateHandlerWithoutData() {
	header := &http.Header{
...
func (s *SessionsTestSuite) TestCreateHandler() {
