...
func (s *SelfTestSuite) TestSettingsPatchHandlerWithoutHeader() {
...
func (s *SelfTestSuite) TestSettingsPatchHandlerByUnauthenticatedUser() {
	header := &http.Header{
...
func (s *SelfTestSuite) TestSettingsPatchHandlerWithoutActionGrant() {
	header := &http.Header{
		"X-Requested-By": []string{"SpaceApi"},
	}
...
func (s *SelfTestSuite) TestSettingsPatchHandlerWithoutKey() {
	cookie := s.CreateSessionCookie(true)
	s.NotNil(cookie)
...
func (s *SelfTestSuite) TestSettingsPatchHandlerWithInvalidKey() {
	cookie := s.CreateSessionCookie(true)
	s.NotNil(cookie)
	user := s.Factory.GetAvailableUser()
	actionToken := s.Factory.NewAction(user).Model.Token
...
func (s *SelfTestSuite) TestSettingsPatchHandlerWithInvalidValue() {
	cookie := s.CreateSessionCookie(true)
	s.NotNil(cookie)
	user := s.Factory.GetAvailableUser()
	actionToken := s.Factory.NewAction(user).Model.Token
...
func (s *SelfTestSuite) TestSettingsPatchHandlerWithInvalidEmail() {
	cookie := s.CreateSessionCookie(true)
	s.NotNil(cookie)
	user := s.Factory.GetAvailableUser()
	actionToken := s.Factory.NewAction(user).Model.Token
...
func (s *SelfTestSuite) TestSettingsPatchHandler() {
	cookie := s.CreateSessionCookie(true)
	s.NotNil(cookie)
	user := s.Factory.GetAvailableUser()
	actionToken := s.Factory.NewAction(user).Model.Token
