...
func (s *SelfTestSuite) TestSettingsListHandlerWithoutHeader() {
...
func (s *SelfTestSuite) TestSettingsListHandlerByUnauthenticatedUser() {
	header := &http.Header{
...
func (s *SelfTestSuite) TestSettingsListHandler() {
	cookie := s.CreateSessionCookie(true)
	s.NotNil(cookie)
