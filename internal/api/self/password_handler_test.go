...
func (s *SelfTestSuite) TestPasswordHandlerWithoutHeader() {
...
func (s *SelfTestSuite) TestPasswordHandlerWithoutToken() {
	header := &http.Header{
...
func (s *SelfTestSuite) TestPasswordHandlerWithoutData() {
...
func (s *SelfTestSuite) TestPasswordHandlerIncorrectData() {
	user := s.Factory.NewUser().Model
	actionToken := s.Factory.NewAction(user).Model.Token
	s.Require().Equal(len(actionToken), 64)
...
func (s *SelfTestSuite) TestPasswordHandlerWithoutPermission() {
	user := s.Factory.NewUser().Model
...
func (s *SelfTestSuite) TestPasswordHandler() {
	user := s.Factory.NewUser().Model
	actionToken := s.Factory.NewAction(user).Model.Token
	s.Require().Equal(len(actionToken), 64)
