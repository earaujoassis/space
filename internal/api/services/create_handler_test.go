...
func (s *ServicesTestSuite) TestCreateHandlerWithoutHeader() {
...
func (s *ServicesTestSuite) TestCreateHandlerByUnauthenticatedUser() {
	header := &http.Header{
...
func (s *ServicesTestSuite) TestCreateHandlerWithoutData() {
	cookie := s.CreateSessionCookie(true)
	s.NotNil(cookie)
...
func (s *ServicesTestSuite) TestCreateHandlerByAdminUser() {
	cookie := s.CreateSessionCookie(true)
	s.NotNil(cookie)
	user := s.Factory.GetAvailableUser()
	actionToken := s.Factory.NewAction(user).Model.Token
...
func (s *ServicesTestSuite) TestCreateHandlerByCommonUser() {
