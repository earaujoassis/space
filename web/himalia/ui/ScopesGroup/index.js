...
const scopesGroup = ({ initialScopes, onChange }) => {
  ...
  return (
    <>
      <div
        className="scopes-group__entry"
        onClick={() => onSelection('public')}
      >
        <div className="scopes-group__checkbox">
          <span className="scopes-group__icon">{setIcon('public')}</span>
      ...
      <div
        className="scopes-group__entry"
        onClick={() => onSelection('openid')}
      >
        <div className="scopes-group__checkbox">
          <span className="scopes-group__icon">{setIcon('openid')}</span>
          <span className="scopes-group__label">
            <code>openid</code>
          </span>
        </div>
      ...
      >
        <div className="scopes-group__checkbox">
          <span className="scopes-group__icon">{setIcon('profile')}</span>
          <span className="scopes-group__label">
            <code>profile</code>
          </span>
        </div>
      ...
      <div className="scopes-group__entry" onClick={() => onSelection('email')}>
        <div className="scopes-group__checkbox">
          <span className="scopes-group__icon">{setIcon('email')}</span>
          <span className="scopes-group__label">
            <code>email</code>
          </span>
        </div>
      ...
      <div className="scopes-group__entry">
        ...
        <div className="scopes-group__description">
          ...
          <p>Obtain data for user authentication and authorization only</p>
          <p>
            (Removed) Read user profile data under OAuth 2.0 Provider endpoints
          </p>
        </div>
      </div>
      <div className="scopes-group__entry">
        ...
        <div className="scopes-group__description">
          ...
          <p>Obtain data for user authentication and authorization only</p>
          <p>
            Update user data &mdash; this scope can&#39;t be claimed by other
            applications
          </p>
        </div>
      </div>
