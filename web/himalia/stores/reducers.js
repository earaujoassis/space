...
const reducer = (state = initialState, action) => {
  switch (action.type) {
    case actionTypes.INTERNAL_DISPLAY_TOAST:
      return internalSetToastDisplay(state, action)
    case actionTypes.INTERNAL_RECORD_START:
      return internalRecordStart(state, action)
    case actionTypes.INTERNAL_RECORD_SUCCESS:
      return internalRecordSuccess(state, action)
    case actionTypes.INTERNAL_RECORD_ERROR:
      return internalRecordError(state, action)
    case actionTypes.USER_RECORD_START:
      return userRecordStart(state, action)
    case actionTypes.USER_RECORD_SUCCESS:
      return userRecordSuccess(state, action)
    case actionTypes.USER_RECORD_ERROR:
    ...
    case actionTypes.USER_REQUEST_ERROR:
      return userRequestError(state, action)
    case actionTypes.EMAIL_RECORD_START:
      return emailRecordStart(state, action)
    case actionTypes.EMAIL_RECORD_SUCCESS:
    ...
    case actionTypes.SESSION_RECORD_ERROR:
      return sessionRecordError(state, action)
    case actionTypes.CLIENT_RECORD_START:
      return clientRecordStart(state, action)
    case actionTypes.CLIENT_RECORD_SUCCESS:
      return clientRecordSuccess(state, action)
    case actionTypes.CLIENT_RECORD_ERROR:
      return clientRecordError(state, action)
    case actionTypes.SERVICE_RECORD_START:
      return serviceRecordStart(state, action)
    case actionTypes.SERVICE_RECORD_SUCCESS:
      return serviceRecordSuccess(state, action)
    case actionTypes.SERVICE_RECORD_ERROR:
