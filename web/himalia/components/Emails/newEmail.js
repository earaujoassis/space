                ...
                <div className="globals__siblings emails__form-fields">
                    <div className="globals__children">
                        <div className="globals__input-wrapper">
                            ...
                            <input tabIndex="1" required autoComplete="off" id="new-email__address" name="address" inputMode="email" type="email" placeholder="Email address" />
                        </div>
                    </div>
                    <div className="globals__children">
                        <div className="globals__input-wrapper">
                            <input tabIndex="2" type="submit" className="button emails__button" value="Add" />
                        </div>
                    </div>
                </div>
            </form>
