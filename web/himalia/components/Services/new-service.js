                ...
                <form className="form-common" action="." method="post" onSubmit={(e) => {
                    ...
                    <div className="globals__siblings">
                        <div className="globals__input-wrapper">
                            ...
                            <input autoFocus tabIndex="1" required autoComplete="off" id="new-service__name" name="name" type="text" />
                        </div>
                    </div>
                    <div className="globals__siblings">
                        <div className="globals__input-wrapper">
                            <label htmlFor="new-service__description">Description</label>
                            <input tabIndex="2" autoComplete="off" id="new-service__description" name="description" type="text" />
                        </div>
                    </div>
                    <div className="globals__siblings">
                        <div className="globals__input-wrapper">
                            <label htmlFor="new-service__canonical-uri">Canonical URI</label>
                            <input tabIndex="3" required autoComplete="off" id="new-service__canonical-uri" name="canonical_uri" inputMode="url" type="url" onBlurCapture={(e) => prependUrlWithHttps(e)} />
                        </div>
                    </div>
                    <div className="globals__siblings">
                        <div className="globals__input-wrapper">
                            <input tabIndex="4" type="submit" className="button" value="Create service application" />
                        </div>
                    </div>
                </form>
            </div>
...
const mapDispatchToProps = dispatch => {
    return {
        createService: (data, token) => dispatch(actions.createService(data, token))
    }
}
