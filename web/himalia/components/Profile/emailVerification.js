...
const emailVerification = ({ requestEmailVerification, emailVerified }) => {
  ...
  const requestEmailVerificationMessage = emailVerificationRequested ? (
  ...
  return (
    <>
      ...
      <div className="globals__warning-box profile__email-verification">
        <p>
          Your e-mail is not verified. Please request your e-mail verification
          to avoid any disruption in your account access.
        </p>
