...
const security = ({
    ...
    const [resetSecretCodesRequested, setResetSecretCodesRequested] = useState(false)
    ...
    const requestSecretCodesResetMessage = resetSecretCodesRequested ? (processedRequestMessage) : (
        <p>
            <button
                onClick={() => {
    ...
    if (loading.includes('user') || user === undefined || application === undefined) {
        return (
            <>
